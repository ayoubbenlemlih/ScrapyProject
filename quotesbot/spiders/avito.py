...
class LoginSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        files = {'category_group': (None, '7010'),'type': (None, 's'),'lang': (None, 'fr'),'rooms': (None, '')
                ...
                ,'region': (None, '17'),'area': (None, '154'),'address': (None, ''),'subject': (None, 'Samsung Galaxy S3')
                ,'body': (None, 'Je mets en vente mon Samsung Galaxy S3 bleu 16 Gb 1ere main, en très bon état avec un prix raisonnable.'),'mandatory_cv': (None, '0'),'price': (None, '100 000')
