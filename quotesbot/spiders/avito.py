...
'''
        ...
        no_file_multipart_req = requests.Request('POST', 'http://httpbin.org/anything' ,files={'name2': (None, 'content','text/plain')}).prepare()
        self.logger.info(no_file_multipart_req.body.decode('utf-8'))
        self.logger.info( no_file_multipart_req.text)
