...
'''
        ...
        no_file_multipart_req = Request('POST', 'http://httpbin.org/anything' files={'name2': (None, 'content')}).prepare()
        self.logger.info("2"+no_file_multipart_req.body.decode('utf-8'))
