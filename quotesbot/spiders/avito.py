...
class LoginSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        files = {'category_group': (None, '7010'),'type': (None, 's'),'lang': (None, 'fr'),'rooms': (None, '')
                ...
                ,'region': (None, '17'),'area': (None, '154'),'address': (None, ''),'subject': (None, 'kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk')
                ,'body': (None, 'dddddddddddddddddddddddddddddddddddd'),'mandatory_cv': (None, '0'),'price': (None, '100 000')
                 ,'price_meter': (None, '0'),'images_urls[]': (None, ''),'images[]': ('', '','application/octet-stream'),'company_ad': (None, '0')
